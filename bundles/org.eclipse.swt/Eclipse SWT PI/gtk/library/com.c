	...
	(JNIEnv *env, jclass that, jint arg0, jlong arg1, jlong arg2, jlong arg3)
{
	  jint rc = 0;
	    ...
	    jlong *vtbl = (jlong *)*(jlong **)arg1;
	    jint (STDMETHODCALLTYPE *method)(jlong, jlong, jlong) = (jint (STDMETHODCALLTYPE *)(jlong, jlong, jlong))vtbl[arg0];

	    printf("Calling method at index %d with vtbl address %p\n", arg0, (void *)vtbl);

	    rc = (jint)method(arg1, arg2, arg3);

	    printf("COM Method Return Code: %ld\n", (long)rc);
